...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-primary-bg font-inter">
      {/* Header */}
      <header className="sticky top-0 z-30 bg-primary-bg/80 backdrop-blur-xl border-b border-border-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="text-center">
              <h1 className="text-xl font-semibold text-text-primary">FlightFlow</h1>
            </div>
            
            <button
              onClick={() => setAiAssistantOpen(true)}
              className="p-2 hover:bg-primary-secondary rounded-lg transition-colors relative"
            >
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="card rounded-2xl p-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Calendar size={16} className="absolute left-3 top-3 text-text-tertiary" />
                      <input
                        type="date"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Users size={16} className="absolute left-3 top-3 text-text-tertiary" />
                      <select
                ...
                <button
                  ...
                  className="btn-primary w-full py-3 px-6 rounded-lg font-medium flex items-center justify-center gap-2"
                >
                  <Search size={20} />
                  Search Flights
                </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <button
                  ...
                  className="card rounded-2xl p-6 text-left hover:shadow-lg transition-all group"
                >
                  ...
                  <h3 className="text-xl font-semibold text-text-primary mb-2">Your Trips</h3>
                  <p className="text-text-secondary">{mockTrips.length} active bookings</p>
                </button>
                ...
                >
                  ...
                  <p className="text-text-secondary">Get personalized recommendations</p>
                </button>
              </div>
            </motion.div>
          )}
          ...
          {activeView === 'search' && (
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-text-primary">Search Results</h2>
                  <p className="text-text-secondary">{searchResults.length} flights found</p>
                </div>
                <button
              ...
              <div className="space-y-4">
                {searchResults.map((flight, index) => (
                  <motion.div
                    ...
                    className="card rounded-2xl p-6 hover:shadow-lg transition-all cursor-pointer"
          ...
          {activeView === 'trips' && (
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-text-primary">Your Trips</h2>
                  <p className="text-text-secondary">{mockTrips.length} bookings</p>
                </div>
                <button
                  onClick={() => setActiveView('home')}
                  className="btn-secondary px-4 py-2 rounded-lg"
                ...
                {mockTrips.map((trip, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="text-right">
                        <p className="text-xl font-bold text-text-primary">${trip.totalPrice}</p>
                      ...
                      <div key={flight.id} className="border-t border-border-primary pt-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-6">
                            <div className="text-center">
                              <p className="font-semibold text-text-primary">{flight.departure.time}</p>
                              <p className="text-sm text-text-secondary">{flight.departure.airport}</p>
                              <p className="text-xs text-text-tertiary">{flight.departure.city}</p>
                            </div>
                            ...
                            <div className="text-center">
                              <p className="font-semibold text-text-primary">{flight.arrival.time}</p>
                              <p className="text-sm text-text-secondary">{flight.arrival.airport}</p>
                              <p className="text-xs text-text-tertiary">{flight.arrival.city}</p>
                            </div>
                          </div>
